    ...
    <div className="crop-overlay" role="dialog" aria-modal="true" aria-labelledby={titleId}>
      <div className="crop-sheet">
        ...
        <div className="crop-preview-bar">
          ...
          {previewBlobUrl ? (
            <button type="button" className="secondary crop-preview-close" onClick={clearPreview} disabled={busy || exporting}>
              关闭预览
            </button>
          ) : null}
        </div>
        ...
        {previewBlobUrl ? (
          <div className="crop-preview-frame">
            ...
            <p className="crop-preview-caption">以上为按当前选区导出的效果，确认无误后可点「确认裁切」。</p>
          </div>
        ) : null}
